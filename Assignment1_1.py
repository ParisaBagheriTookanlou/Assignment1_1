...
df = pd.read_excel("C:/Users/paris/OneDrive/Desktop/Assignment/purchase_orders_case_study.xlsx")
...
# #### KPI 3: Quantity Order Position Index
...
excluded_ids = ['12', '35']
mask = ~np.isin(unique_product_ids, excluded_ids)

product_ids = unique_product_ids[mask]
